...
<div> 
  ...
  <router-link v-if="state==='1'" :to="{ name: 'Task' }" @click="title='Task'" :class="title==='Task'?'link active':'link'" >
    <el-icon :size="20"><Menu /></el-icon>
     <span style="margin-left: 10px;">作业</span>
 </router-link>
  <router-link v-if="state==='1'||state==='0'" :to="{ name: 'courseMessage' }" :class="title==='courseMessage'?'link active':'link'" @click="title='courseMessage'" >
  <el-icon :size="20"><MessageBox/></el-icon>
   <span style="margin-left: 10px;">通知</span>
 </router-link>
   <router-link v-if="state==='1'||state==='2'" :to="{ name: 'student' }" :class="title==='student'?'link active':'link'" @click="title='student'">
 <el-icon :size="20"><User /></el-icon>
   <span style="margin-left: 10px;">学生详情</span>
 </router-link>
 <router-link v-if="state==='0'||state==='1'" :to="{ name: 'Aichat' }" :class="title==='Aichat'?'link active':'link'" @click="title='Aichat'">
 ...
 <span style="margin-left: 10px;">聊天助手</span>
  ...
  <router-link v-if="state==='0'" :to="{ name: 'examine' }" :class="title==='examine'?'link active':'link'" @click="title='examine'">
